...
> - `WHITELIST-MODE-DESIGN-NOTES.md` — gated/family-server mode (DESIGN LOCKED 2026-07-04; BUILT Stages A–D same day; live-tested end-to-end 2026-07-05 — see `WalkThrough.wiki` for the operator recipe).
...
├── range.js               — HTTP Range header parser for gateway seek support (pure functions).
